...
function init() {
    ...
    processArgs(process.argv).forEach(coords => {
    ...
    const base64Image = Buffer.from(buf, 'latin1').toString('base64');
    const base64ImageStr = `data:image/duvalJPG;base64,${base64Image}`;
    // console.log(`<img src='${base64ImageStr}'>`)
    // console.log(base64ImageStr)
    process.stdout.write(buf)
    fs.writeFileSync(fileName, buf)
    // fs.writeFileSync('dataimg.txt', base64ImageStr)
}
