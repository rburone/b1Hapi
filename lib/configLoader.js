...
Hoek.assert(!dotenv.error, '.env file is missing!')
Joi.assert(dotenv.parsed, internals.dotenvShema)

module.exports = {
    name: 'configLoader',
    read() {
        const confFile = `${dotenv.parsed.CONFIG_FILE}.js`
